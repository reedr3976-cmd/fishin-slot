...
# Scanner V11 — near-miss refinement research (research only; no live changes)
SCANNER_V11_REPORT_TXT = "output/scanner_v11_report.txt"
SCANNER_V11_REPORT_JSON = "output/scanner_v11_report.json"
V11_TRAIN_END = V10_TRAIN_END
V11_VAL_END = V10_VAL_END
V11_N_FOLDS = V10_N_FOLDS
V11_MAX_DD_ACCEPT = V10_MAX_DD_ACCEPT
V11_MIN_FOLDS_POSITIVE = V10_MIN_FOLDS_POSITIVE
V11_MIN_TRADES = V10_MIN_TRADES
V11_MIN_HELDOUT_TRADES = V10_MIN_HELDOUT_TRADES
V11_MIN_SYMBOLS_POSITIVE = V10_MIN_SYMBOLS_POSITIVE
V11_MC_RUNS = V10_MC_RUNS
V11_MC_SEED = 23
V11_ATR_STOP_MULT = V10_ATR_STOP_MULT
V11_MAX_HOLD = V10_MAX_HOLD
V11_ENTRY_SLIP_ATR = V10_ENTRY_SLIP_ATR
V11_MIN_ROTATION_POSITIVE = V10_MIN_ROTATION_POSITIVE
V11_PIVOT = V10_PIVOT
V11_ADX_WEAK = 18.0
V11_ADX_STRONG = 25.0
V11_SR_ZONE_ATR = 0.5
V11_FVG_MAX_AGE = V10_FVG_MAX_AGE
V11_RR_TARGET = V10_RR_TARGET
V11_STOCK_DEV = V10_STOCK_DEV
V11_STOCK_FINAL_INST = V10_STOCK_FINAL_INST
V11_STOCK_ROTATIONS = V10_STOCK_ROTATIONS
V11_COMM_DEV = V10_COMM_DEV
V11_COMM_FINAL_INST = V10_COMM_FINAL_INST
V11_METALS_DEV = V10_METALS_DEV
V11_METALS_FINAL_INST = V10_METALS_FINAL_INST
V11_FX_DEV = V10_FX_DEV
V11_FX_FINAL_INST = V10_FX_FINAL_INST
V11_MACRO_KEYS = V10_MACRO_KEYS

# Scanner V12 — data expansion + frozen V11_S_FVG_SWEEP replication (research only)
SCANNER_V12_REPORT_TXT = "output/scanner_v12_report.txt"
SCANNER_V12_REPORT_JSON = "output/scanner_v12_report.json"
V12_DUKA_START_ISO = "2010-01-01T00:00:00+00:00"
V12_TRAIN_END = V11_TRAIN_END
V12_VAL_END = V11_VAL_END
V12_N_FOLDS = V11_N_FOLDS
V12_MAX_DD_ACCEPT = V11_MAX_DD_ACCEPT
V12_MIN_FOLDS_POSITIVE = V11_MIN_FOLDS_POSITIVE
V12_MIN_TRADES = V11_MIN_TRADES
V12_MIN_HELDOUT_TRADES = V11_MIN_HELDOUT_TRADES
V12_MIN_SYMBOLS_POSITIVE = V11_MIN_SYMBOLS_POSITIVE
V12_MC_RUNS = V11_MC_RUNS
V12_MC_SEED = 29
V12_ENTRY_SLIP_ATR = V11_ENTRY_SLIP_ATR
V12_STOCK_DEV = V11_STOCK_DEV
V12_STOCK_FINAL_INST = V11_STOCK_FINAL_INST
V12_STOCK_ROTATIONS = V11_STOCK_ROTATIONS
V12_COMM_DEV = V11_COMM_DEV
V12_COMM_FINAL_INST = V11_COMM_FINAL_INST
V12_FX_DEV = V11_FX_DEV
V12_FX_FINAL_INST = V11_FX_FINAL_INST
V12_MACRO_KEYS = V11_MACRO_KEYS
# Yahoo-era boundary for extended-history confirmation reporting (~730d 1h pre-V12)
V12_YAHOO_APPROX_START_ISO = "2023-10-01T00:00:00+00:00"

# Scanner V13 — confirmation research ONLY for frozen V12 E3 (no optimisation, no live)
SCANNER_V13_REPORT_TXT = "output/scanner_v13_report.txt"
SCANNER_V13_REPORT_JSON = "output/scanner_v13_report.json"
V13_DUKA_START_ISO = V12_DUKA_START_ISO
V13_YAHOO_CUTOFF_ISO = V12_YAHOO_APPROX_START_ISO  # 2023-10-01
V13_TRAIN_END = V12_TRAIN_END
V13_VAL_END = V12_VAL_END
V13_N_FOLDS = V12_N_FOLDS
V13_MAX_DD_ACCEPT = V12_MAX_DD_ACCEPT
V13_MIN_FOLDS_POSITIVE = V12_MIN_FOLDS_POSITIVE
V13_MIN_TRADES = V12_MIN_TRADES
V13_MIN_HELDOUT_TRADES = V12_MIN_HELDOUT_TRADES
V13_MIN_SYMBOLS_POSITIVE = V12_MIN_SYMBOLS_POSITIVE
V13_MC_RUNS = V12_MC_RUNS
V13_MC_SEED = 31
V13_ENTRY_SLIP_ATR = V12_ENTRY_SLIP_ATR
V13_STOCK_DEV = V12_STOCK_DEV
V13_STOCK_FINAL_INST = V12_STOCK_FINAL_INST
V13_STOCK_ALL = tuple(V12_STOCK_DEV) + tuple(V12_STOCK_FINAL_INST)
V13_COST_MULTS = (1.0, 1.5, 2.0, 3.0)
# Independent eras (UTC ISO). Earliest/middle derived from available panel at runtime.
V13_ERA_PRE_YAHOO_END = V13_YAHOO_CUTOFF_ISO
V13_ERA_YAHOO_START = V13_YAHOO_CUTOFF_ISO
